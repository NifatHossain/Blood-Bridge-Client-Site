    ...
    return (
        <div>
                    ...
                    <div className="flex justify-center gap-6">
                        <div className="flex flex-col space-y-4">
                            <div className="flex items-center gap-1">
                                ...
                                <a className="text-base hover:text-red-500" href="">Thalassemia</a>
                            </div>
                            <div className="flex items-center gap-1">
                                <BiSolidRightArrow className="text-red-500" />
                                <a className="text-base hover:text-red-500" href="">Myelodysasia</a>
                            </div>
                            <div className="flex items-center gap-1">
                                <BiSolidRightArrow className="text-red-500" />
                                <a className="text-base hover:text-red-500" href="">Blood Count</a>
                            </div>
                            <div className="flex items-center gap-1">
                                <BiSolidRightArrow className="text-red-500" />
                                <a className="text-base hover:text-red-500" href="">Cell Elofrosis</a>
                            </div>
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                <BiSolidRightArrow className="text-red-500" />
                                <a className="text-base hover:text-red-500" href="/donationrequests">Donation Requests</a>
                            </div>
                            <div className="flex items-center gap-1">
                                <BiSolidRightArrow className="text-red-500" />
                                <a className="text-base hover:text-red-500" href="searchdonar">Search Donar</a>
                            </div>
                            <div className="flex items-center gap-1">
                                <BiSolidRightArrow className="text-red-500" />
            ...
            <div className="footer footer-center p-4 bg-neutral text-neutral-content">
                <aside>
                    <p>Copyright © 2024 - All right reserved by Blood Bridge Org.</p>
                </aside>
            </div>
        </div>
    );
